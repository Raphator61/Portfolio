...
function ProjectCard({ project, onOpen }: { project: Project; onOpen: (p: Project) => void }) {
  return (
    <button
      ...
      className="group shrink-0 w-72 text-left bg-surface border border-border rounded-xl p-5 hover:border-accent/60 transition-colors"
    >
      ...
      <p className="mt-2 text-sm text-text-secondary leading-relaxed">{project.summary}</p>
